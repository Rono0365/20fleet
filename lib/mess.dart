...
chatdata2.map((ex) => ex['useryou'].toString().contains(widget.user.toString())
  ...
  Future checkme() async {
    ...
    if (responsev2.statusCode == 201) {
      talos7.removeLast();
      print("yea it happened");
      //print(jsonDecode(responsev2.body.toString()));
    ...
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          title: Chip(
              ...
              //avatar:                  CircleAvatar(radius: 7, backgroundColor: Colors.lightGreen),
...
//                                              : Container(),
                                    ...
                                    : u['writer'] == widget.title.toString() && u['to'] == widget.user
                                        ? Column(children: [
                                            Dismissible(
                                              confirmDismiss:
                                                  (direction) async {
